...
static const char *fonts[]          = { "GohuFont 11 Nerd Font Mono:size=12" };
static const char dmenufont[]       = "GohuFont 11 Nerd Font Mono:size=12";
...
static const char *menucmd[]  = { "eww-menu", NULL };

static const Key keys[] = {
	/* modifier                     key        function        argument */
	{ MODKEY,						XK_Escape, spawn,		   {.v = menucmd } },
